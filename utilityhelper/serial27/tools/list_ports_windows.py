...
import serial27
from serial27.win32 import ULONG_PTR, is_64bit
...
Ports = serial27.to_bytes([80, 111, 114, 116, 115]) # "Ports"
PortName = serial27.to_bytes([80, 111, 114, 116, 78, 97, 109, 101]) # "PortName"
